        ...
        <Card className="lg:col-span-2 border-none shadow-xl overflow-hidden bg-white">
          <CardHeader className="border-b border-slate-50 pb-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <div className="flex items-center gap-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-tighter bg-slate-50 px-2 py-1 rounded">
                  <div className="h-2 w-2 rounded-full bg-accent" /> Net Revenue
                </div>
              </div>
            </div>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              <div className="p-4 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm">
                <p className="text-sm italic leading-relaxed">
                  "Based on current burn and revenue trajectory, your runway has improved by 2 months. Focus on 'Series A' milestone readiness in the next 60 days."
                </p>
              </div>
